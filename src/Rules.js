...
const enRules =
  <ol>
    ...
    <li>If the highlighted word is red, the turn automatically goes to the next team.</li>
    ...
    <li>If the team guesses the song incorrectly, but the word revealed from the card the team just opened appears in the song, then the team may continue. Otherwise, the turn goes to the next team.</li>
    <li>If the team is unable to form a song from the word, the turn goes to the next team.</li>
    <li>The team that first sings the right song and the right part of the song gets the point. Team also needs to know the song name and artist.</li>
    ...
    <li>The teams start the round alternately.</li>
...
const fiRules =
  <ol>
    ...
    <li>Jos esille käännetty sana on punainen, vuoro siirtyy automaattisesti seuraavalle joukkueelle.</li>
    <li>Vuoron alussa joukkue valitsee avaako seuraavan luukun vai arvaako joukkue laulun jo näkyvien sanojen avulla.</li>
    <li>Jos joukkue arvaa laulun väärin, mutta joukkueen juuri avaamasta luukusta paljastunut sana (tai sen taivutettu muoto) esiintyy laulussa, niin joukkue saa jatkaa. Muutoin vuoro siirtyy seuraavalle joukkueelle.</li>
    <li>Mikäli joukkue ei pysty muodostamaan sanasta laulua, siirtyy vuoro seuraavalle joukkueelle.</li>
    <li>Pisteen saa se joukkue, joka ensimmäisenä laulaa oikean laulun ja oikean kohdan laulusta. Tiimin pitää myös tietää laulun nimi ja artisti.</li>
